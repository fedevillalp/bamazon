This is a command line App that connects to a mySQL databases and displays a table containing a list of products with different prices and belonging to different categories.
